...
<div class="wrap">
                                            ...
                                            <div class="swiper-slide is-content">
                                                <div class="slider_info-top s1">
                                                    ...
                                                    <div class="slider-title">
                                                        <p class="slider-title-text-artist">
                                                            NEW JEANS
                                                        </p>
                ...
                <section class="eventTab-warp container">
                    <h2 class="blind">EVENT</h2>
                                    ...
                                    <div class="swiper-slide is-pretxt">
                                        ...
                                        <div class="slider_pre-middle pt2">
                                            <p class="slider_pre-info">
                                                Ktown4u와 함께 다양한 상품을 <br />
                                                미리 만나보세요!
                                            </p>
                                            <div class="slider_pre-tag">
                                                <a
                                                    href="javascript:void(0)"
                                                    class="slider_pre_tagline on"
                                                    >K-POP</a
                                                >
                                                <a
                                                    href="javascript:void(0)"
                                                    class="slider_pre_tagline"
                                                    >K-CONTENTS
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="prebx-capsule">
                                                ...
                                                <div class="prebx-capsule-text">
                                                    ...
                                                    <div class="capsule-price">
                                                        <span class="capsule-price-nego"
                                                            >19,300원</span
                                                        >
                                                        <span class="capsule-price-net"
                                                            >23,800원</span
                                                        >
                                                    </div>
                                                </div>
                ...
                <section class="new_life new container">
                    <div class="new_life-wrap">
                                    ...
                                    <div class="nl-info nm1">
                                        ...
                                        <div class="nl_text">
                                            <strong class="nl_text-title">
                                                PLAVE - 1st Mini Album [ASTERUM : The Shape of
                                                Things to Come]
                                            </strong>
                        ...
                        <a href="javascript:void(0)" class="new_life-_header-info2">더보기</a>
                    </div>
                </section>
                                    ...
                                    <div class="nl-info nm1">
                                        <div class="nl-img">
                                            <img
                                                ...
                                                alt="[특전 포토카드 증정] 온그리디언츠 김바덕 제주 시카
                                                클렌징 볼"
                                            />
                                        </div>
                                        <div class="nl_text">
                                            ...
                                            <div class="chartbx_capsule">
                                                <div class="chartbx_capsule-img">
                                                    <img
                                                        ...
                                                        alt="레비 (LE'V) - 1st EP Album [A.I.BAE]
                                                        (POCAALBUM)"
                                                    />
                                                </div>
                                    ...
                                    <div class="chart_capsule">
                                        <a href="javascript:void(0)" class="chart_capsule-wrap">
                                            <div class="chartbx_capsule">
                                                ...
                                                <div class="chartbx_capsule-text">
                                                    <span class="chartbx_capsule-artist cca3"
                                                        >V</span
                                                    >
                                                    <span class="chartbx_capsule-albumtitle"
                                                        >V - [Layover] <br />
                                    ...
                                    <a href="javascript:void(0)" class="chart_4-add-text">
                                        ...
                                        <div class="chart_4-add-contents">
                                            ...
                                            <span class="chart_4-add-album"
                                                >NCT 2023 - 정규앨범 4집 [Golden Age] <br />
                                                (Archiving Ver.)</span
                                            >
                                ...
                                <li class="chart_4-add ch8">
                                    <a href="javascript:void(0)" class="chart_4-add-text">
                                        ...
                                        <div class="chart_4-add-contents">
                                            ...
                                            <span class="chart_4-add-album"
                                                >블랙핑크 (BLACKPINK) - 블랙핑크 더 게임 OST <br />
                                                [THE GIRLS] Reve Black ver. (LIMITED EDITION)</span
                                            >
                                            <span class="chart_4-add-release"
                                ...
                                <li class="chart_4-add ch9">
                                    <a href="javascript:void(0)" class="chart_4-add-text">
                                        ...
                                        <div class="chart_4-add-contents">
                                            ...
                                            <span class="chart_4-add-album"
                                                >트레저 (TREASURE) - 2ND FULL ALBUM <br />
                                                [REBOOT] PHOTOBOOK VER.</span
                                            >
                                            <span class="chart_4-add-release"
                ...
                <section class="ktown4u_offline">
                    <div class="ktown4u_offline-wrap">
                        <a href="#" target="_blank" title="새창 열림" class="offline-text">
                ...
                <section class="brandshop">
                    <div class="brandshop-wrap container">
                        <div class="brandshop-header">
                            <span class="brandshop-header_tagline">BARND SHOP</span>
                            <h2 class="brandshop-header_tagtit">브랜드샵</h2>
                            <div class="brandshop-header_taginfo">
                                <span class="brandshop-header-info1"
                                    >Ktown4u에서도 만나볼 수 있다! 다양한 브랜드샵들을 만나보세요!
                                </span>
                            </div>
                        </div>
                        <div class="swiper is-brand">
                            <div class="swiper-wrapper is-brand">
                                ...
                                <div class="swiper-slide is-brand">
                                    <a href="javascript:void(0)" class="brandshop_circle">
                                        <img src="./images/main/BRAND_2.jpg" alt="수앙 스튜디오" />
                                        <h2>SOOANG STUDIO</h2>
                                    </a>
                                </div>
                                <div class="swiper-slide is-brand">
                                ...
                                <div class="swiper-slide is-brand">
                                    <a href="javascript:void(0)" class="brandshop_circle">
                                        <img src="./images/main/BRAND_11.png" alt="FIORO STUDIO" />
                                        <h2>FIORO STUDIO</h2>
                                    </a>
                                </div>
                                <div class="swiper-slide is-brand">
